...
//echo $ma_tgia;
   //Kết nối tới DB Server
    ...
    //cau lenh  
    $xoa_kc = "SET PRIMARY_KEY_CHECKS = 0";    
    $xoa_sql = "DELETE FROM baiviet WHERE `baiviet`.`ma_bviet` = $ma_bviet";
    $tao_kc = "SET PRIMARY_KEY_CHECKS = 1";
    mysqli_query($conn,$xoa_kc);
    mysqli_query($conn,$xoa_sql);
    mysqli_query($conn,$tao_kc);
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                        ...
                        <input type="1" class="form-control" name="ma_bviet" >
                    </div>
